...
/**
 * Synchronous SHA-256 for code shared by the browser and server.
 * PDF-byte hashing continues to use Web Crypto; this helper is for small,
 * deterministic state projections that must be available inside reducers.
 */
