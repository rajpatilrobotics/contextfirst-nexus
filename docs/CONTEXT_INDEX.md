...
| How are models routed and recovered? | `docs/MODEL_ROUTING.md` | Replay-only analysis binding, provider registry, adapters, release admission, managed routing, safe fallback, disclosures, and provider-specific restrictions |
...
| Analysis start, disclosure, managed routing, or recovery | `docs/PRODUCT_SPEC.md` Sections 1.1, 5, 7.3, and 7.5; `docs/CONTRACTS.md` Sections 1.1, 4.7, 16, and 18; `docs/MODEL_ROUTING.md` Sections 6 and 7; `docs/DESIGN_SYSTEM.md` Sections 1.1, 9.2, 9.3, and 10.1; `docs/SAFETY_AND_DATA.md` in full | `decision-log.md` DEC-045; `docs/TESTING_AND_EVALUATION.md` Sections 1.1, 7.2, and 9 |
